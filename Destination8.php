...
<div class="row">
  ...
  <a href="Destination_8_hotel_1.php "><img src="h15.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane">  Andaz Singapore – A Concept by Hyatt</span></div><br>
    ...
    <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_8_hotel_2.php  "><img src="h9.jpg" class="image"></a>
  <div class="caption middle">
                         
                            <div> <span class="fas fa-plane"> Hotel Indigo Singapore Katong</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_8_hotel_3.php  "><img src="h18.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane">   Hotel Jen Orchardgateway Singapore by Shangri-La </span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_8_hotel_4.php  "><img src="h4.jpg" class="image"></a>
  <div class="caption middle">
                          
                            <div> <span class="fas fa-plane">  One Farrer Hotel</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
