...
<div class="row">
  ...
  <a href="Destination_1_hotel_1.php "><img src="h1.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane"> New York Marriott Marquis</span></div><br>
                      ...
                      <div><i class="fa fa-tags"> &nbsp; Children : $1500</i></div>
                            ...
                            <hr style="border-top: 1px solid red;">
                            <center><a class="btn btn-primary" href="Destination_1_hotel_1.php" role="button">Book Now</a></center>
                        </div>
  </div>
  </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_1_hotel_2.php  "><img src="h2.jpg" class="image"></a>
  <div class="caption middle">
                         
                            <div> <span class="fas fa-plane">  New York Hilton Midtown</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
                      ...
                      <div><i class="fa fa-tags"> &nbsp; Children : $1300</i></div>
                            ...
                            <p style="word-spacing: 10px;">20 Hotels   .24 cars   .20+ Tours </p>
                            <hr style="border-top: 1px solid red;">
                            <center><a class="btn btn-primary" href="Destination_1_hotel_2.php" role="button">Book Now</a></center>
                        </div>
  </div>
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href=" Destination_1_hotel_3.php "><img src="h3.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane"> Sheraton New York Times Square Hotel</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
                      ...
                      <div><i class="fa fa-tags"> &nbsp; Children : $1000</i></div>
                            ...
                            <p style="word-spacing: 10px;">20 Hotels   .24 cars   .20+ Tours </p>
                            <hr style="border-top: 1px solid red;">
                            <center><a class="btn btn-primary" href="Destination_1_hotel_3.php" role="button">Book Now</a></center>
                        </div>
  </div>
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href=" Destination_1_hotel_4.php "><img src="h4.jpg" class="image"></a>
  <div class="caption middle">
                          
                            <div> <span class="fas fa-plane">  Hotel Pennsylvania</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
                      ...
                      <div><i class="fa fa-tags"> &nbsp; Children : $1200</i></div>
                            ...
                            <p style="word-spacing: 10px;">20 Hotels   .24 cars   .20+ Tours </p>
                            <hr style="border-top: 1px solid red;">
                            <center><a class="btn btn-primary" href="Destination_1_hotel_4.php" role="button">Book Now</a></center>
                        </div>
  </div>
  </div>
