...
<div class="row">
  ...
  <a href="Destination_4_hotel_1.php "><img src="h13.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane">   Acta Voraport</span></div><br>
    ...
    <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_4_hotel_2.php "><img src="h14.jpeg" class="image"></a>
  <div class="caption middle">
                         
                            <div> <span class="fas fa-plane">  Hotel Barcelona 1882</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href=" Destination_4_hotel_3.php"><img src="h15.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane">   Motel One Barcelona-Ciutadella</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_4_hotel_4.php "><img src="h16.jpg" class="image"></a>
  <div class="caption middle">
                          
                            <div> <span class="fas fa-plane">  Room Mate Gerard </span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
