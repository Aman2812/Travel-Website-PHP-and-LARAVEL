...
<div class="row">
  ...
  <a href="Destination_7_hotel_1.php "><img src="h1.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane">  The Glen Boutique Hotel & Spa</span></div><br>
    ...
    <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_7_hotel_2.php  "><img src="h11.jpg" class="image"></a>
  <div class="caption middle">
                         
                            <div> <span class="fas fa-plane">  Taj Cape Town</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_7_hotel_3.php  "><img src="h17.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane">   Vineyard Hotel</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href=" Destination_7_hotel_4.php "><img src="h8.jpg" class="image"></a>
  <div class="caption middle">
                          
                            <div> <span class="fas fa-plane">  The Table Bay Hotel</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
