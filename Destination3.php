...
<div class="row">
  ...
  <a href="Destination_3_hotel_1.php "><img src="h9.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane">  Ekaa Villa - A Boutique Hotel</span></div><br>
    ...
    <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_3_hotel_2.php  "><img src="h10.jpg" class="image"></a>
  <div class="caption middle">
                         
                            <div> <span class="fas fa-plane">  The Oberoi Amarvilas Agra</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_3_hotel_3.php  "><img src="h11.jpg" class="image"></a>
  <div class="caption middle">
                           
                            <div> <span class="fas fa-plane">   Courtyard by Marriott Agra</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-6 col-xs-12">
    <div class="thumbnail">
  <a href="Destination_3_hotel_4.php  "><img src="h12.jpg" class="image"></a>
  <div class="caption middle">
                          
                            <div> <span class="fas fa-plane">  Hotel Atulyaa Taj</span></div><br>
                            <div><span class="fas fa-star color-red"></span>
                            <span class="fa fa-star color-yellow"></span>
                          <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
